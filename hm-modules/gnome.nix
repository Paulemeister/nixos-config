    ...
    })
    {
      ...
      dconf = {
        ...
        settings = {
          ...
          # Configure pop-shell
          "org/gnome/shell/extensions/pop-shell" = {
            gap-inner = lib.mkDefault (lib.hm.gvariant.mkUint32 osCfg.de.gnome.popBorderSize);
            gap-outer = lib.mkDefault (lib.hm.gvariant.mkUint32 osCfg.de.gnome.popBorderSize);
